...
function planTrip(totalDistance, avgSpeed, startDate, initialCycleTime) {
    ...
    while (remainingDistance > 0) {
        ...
        let drivingHours = Math.min(availableHOS.drivingTime, remainingDistance / avgSpeed);
        
        // Ensure we don't exceed 11 hours of driving
        drivingHours = Math.min(drivingHours, 11);
